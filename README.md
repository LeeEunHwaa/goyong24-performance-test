...
| ID | 테스트 항목 | AOS 코드 바로가기 | iOS 코드 바로가기 |
|:---:|:-----------|:-------------|:-------------|
| **TC-01** | 앱 실행 속도 |[🔗 코드 보기](#) | [🔗 코드 보기](#) |
| **TC-02** | 로그인 속도 (ID/PW) | [🔗 코드 보기](#) | [🔗 코드 보기](#) |
| **TC-03** | 로그인 속도 (인증서) | [🔗 코드 보기](#) | [🔗 코드 보기](#) |
| **TC-04** | 검색 속도 | [🔗 코드 보기](#) | [🔗 코드 보기](#) |
...
| **TC-02** | **로그인 속도 (ID/PW)** | 로그인 버튼 클릭 \~ 로그인 완료 팝업/화면 등장 | 반자동(Semi-auto) |
| **TC-03** | **로그인 속도 (인증서)** | 인증서 완료 버튼 클릭 \~ 로그인 완료 | 반자동(Semi-auto) |
